...
public class Autentificare {
    ...
    public void handleLoginAction() {
        ...
        try{
            ...
            if(stored_password.equals(encoded_password)){
                ...
                if(UserService.getUser(username).getRole().equals("Agent")){
                    loadAgentHomePage();
                    return;
                }
    ...
    public void loadRegisterPage(){
        try {
            ...
            stage.setTitle("Inregistrare - Real Estate App");
    ...
    private void loadHomePage(){
        try{
            ...
            Stage stage = (Stage) loginMessage.getScene().getWindow();
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/fxml/PaginaListari.fxml"));
            stage.setUserData(u);
    ...
    @FXML
    private void loadAgentHomePage(){
        try{
            User u = UserService.getUser(usernameField.getText());
            Stage stage = (Stage) loginMessage.getScene().getWindow();
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/fxml/AgentHomePage.fxml"));
            stage.setUserData(u);
            Parent homeRoot = loader.load();
            Scene scene = new Scene(homeRoot, 640, 480);
            stage.setTitle("Real Estate App");
